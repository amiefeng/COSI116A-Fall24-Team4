    ...
    function drawLines() {
      gMap
        ...
        .on('mouseover', function (d) {
            ...
            if (d.color === "#00843D" || d.name.includes("Green")) {
              // Select all lines with the same color or name and turn them green
              d3.selectAll(".line")
              .filter(function (line) {
              return line.color === d.color || line.name.includes("Green");
              })
              .attr("stroke", "#00843D"); // Set the green color
              }
          d3.select(this).attr('stroke', d.color); // Change the stroke color on hover
        })
